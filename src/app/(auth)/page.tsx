      ...
      <div className="flex flex-col items-center justify-center gap-4">
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-gradient-to-r
             from-blue-500/30 to-purple-500/30 dark:from-blue-500/10 dark:to-purple-500/10 text-sm text-slate-800 dark:text-gray-400 cursor-default"
        >
        ...
        <motion.h1
          ...
          className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-slate-600 to-slate-500 dark:from-gray-100 dark:to-gray-300 text-transparent bg-clip-text cursor-default"
        >
